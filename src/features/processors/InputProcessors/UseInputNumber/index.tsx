...
function ConnectToState() {
  ...
  const { register } = useInputNumber({ changeMode: "onBlur", validateMode: "onBlur" });
      ...
      <ConnectToStateTemplate
        ...
        input={
          <InputBox
            ...
            {...register({
              name: "inputA",
              onChangeValue: (value) => setValueA(value || 0),
            })}
          />
        }
      />
        ...
        input={
          <InputBox
            ...
            {...register({
              ...
              value: valueC,
              maxValue: 1000,
              onChangeValue: (value) => setValueC(value || 0),
...
function MultipleDynamicInputs() {
  ...
  const { values, register, unregister } = useInputNumber();
